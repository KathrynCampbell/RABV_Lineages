...
#' **Importing the Data**
all_data<-read.csv("Cosmo_N_all/Outputs/Cosmo_N_all_sequence_data.csv", stringsAsFactors=FALSE)
...
for (i in 166:length(clusters)) {
  ...
  col_pal <- c("0-1"=cols[1], "1-2"=cols[2], "2-3"=cols[3], "3-4"=cols[4], "4-5"=cols[5], "5-10"=cols[6], "10-15"=cols[7], 
               "15-20"=cols[8], "20-30"=cols[9], "30-50"=cols[10], "50-100"=cols[11])
  ...
  png(paste("Cosmo_N_all/Figures/Lineage_timemaps/", clusters[i], ".png", sep = ""), width = 2000, height = 1000)
